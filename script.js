const translations = {
    pt: {
        ...
        "endorsement-4-text": "\"Faça Chuva, Faça Sol é um daqueles livros que nos fazem refletir sobre a vida.<br><br>Eduardo Fernandes de Freitas compartilha sua trajetória com muita honestidade, narrando uma infância marcada por ausências, dificuldades e desafios que poderiam ter definido seu destino. Em muitos momentos, chorei junto com aquele menino. Em outros, torci por cada conquista como se fosse alguém da minha própria família.<br><br>Mas este não é um livro sobre sofrimento.<br><br>É um livro sobre reconstrução.<br><br>Entre algumas das muitas passagens que me marcaram estão as lições aprendidas na apicultura, que se transformam em belas reflexões sobre cooperação, liderança e propósito, e o hábito de escrever redações desde a adolescência com o padrasto, mostrando como pequenos incentivos podem mudar completamente uma vida.<br><br>A fé, a família e o trabalho aparecem ao longo de toda a narrativa como um verdadeiro alicerce para seguir em frente.<br><br>Terminei a leitura em um único dia e fechei o livro com uma certeza: nossa origem pode explicar parte da nossa história, mas não precisa definir o nosso futuro.<br><br>Uma leitura sensível, inspiradora e profundamente humana. Recomendo.\"",
        "endorsement-4-author": "— Cristina Soares",
        "endorsement-4-country": "Brasil",

        "endorsement-5-text": "\"Uma história que vale a pena ser lida, que prende a atenção do início ao fim e traz lições que só uma vida real, vivida com substância, pode trazer!\"",
        "endorsement-5-author": "— Emanoele",
        "endorsement-5-country": "Brasil",
    ...
    en: {
        ...
        "endorsement-4-text": "\"No Matter the Weather is one of those books that makes us reflect on life.<br><br>Eduardo Fernandes de Freitas shares his journey with great honesty, narrating a childhood marked by absence, hardship, and challenges that could have defined his destiny. In many moments, I cried alongside that boy. In others, I cheered for every achievement as if he were part of my own family.<br><br>But this is not a book about suffering.<br><br>It is a book about rebuilding.<br><br>Among the many passages that stood out to me are the lessons learned in apiculture, which transform into beautiful reflections on cooperation, leadership, and purpose, and the habit of writing essays with his stepfather since adolescence, showing how small encouragements can completely change a life.<br><br>Faith, family, and hard work appear throughout the entire narrative as a true foundation for moving forward.<br><br>I finished reading it in a single day and closed the book with a certainty: our origin can explain part of our history, but it doesn't have to define our future.<br><br>A sensitive, inspiring, and deeply human read. Highly recommended.\"",
        "endorsement-4-author": "— Cristina Soares",
        "endorsement-4-country": "Brazil",

        "endorsement-5-text": "\"A story well worth reading, gripping from start to finish, and packed with lessons that only a real life, lived with substance, can bring!\"",
        "endorsement-5-author": "— Emanoele",
        "endorsement-5-country": "Brazil",
